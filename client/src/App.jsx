...
import UnauthorizedPage from "./pages/unAuthorizedPage"; // yeni sayfa import
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/admin/gallery-cat" element={<AdminCreateGalleryCat />} />
        ...
        <Route path="/admin/create-pool-img" element={<AdminCreatePoolImg />} />
        <Route
        ...
        <Route path="/admin/create-pool-teo" element={<AdminCreatePoolTeo />} />
        <Route
          path="/admin/update-pool-teo/:id"
          element={<AdminUpdatePoolTeo />}
        />
        <Route path="/admin/create-teo-exam" element={<AdminCreateTeoExam />} />
        <Route path="/admin/create-img-exam" element={<AdminCreateImgExam />} />
        <Route path="/admin/create-both-exam" element={<AdminUnifiedExam />} />
        <Route
